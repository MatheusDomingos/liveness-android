...
import com.acesso.acessobiosample.utils.bitmap.ImageUtils;
import com.acesso.acessobiosample.utils.camera.AutoFitTextureViewHomolog;
...
import com.acesso.acessobiosample.utils.camera.ImageSize;
import com.acesso.acessobiosample.utils.exif.Exif;
...
public class Camera2BaseHomolog extends BaseCameraActivityHomolog implements View.OnClickListener {
    ...
    protected AutoFitTextureViewHomolog textureView;
    ...
    protected final CameraDevice.StateCallback stateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(@NonNull CameraDevice cameraDevice) {
            ...
            Camera2BaseHomolog.this.cameraDevice = cameraDevice;
        ...
        public void onDisconnected(@NonNull CameraDevice cameraDevice) {
            ...
            cameraOpenCloseLock.release();
            cameraDevice.close();
            Camera2BaseHomolog.this.cameraDevice = null;
        }
