...
public class BioLivenessService {

    protected static final String TAG = "BioLivenessService.java";
    ...
    public void sendLiveness (LivenessRequest livenessRequest) {
        ...
        ServiceGenerator
                .createService(com.acesso.acessobiosample.services.BioService.class)
