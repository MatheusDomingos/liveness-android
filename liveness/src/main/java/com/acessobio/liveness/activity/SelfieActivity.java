...
import com.acessobio.liveness.support.BioMaskView;
import com.acessobio.liveness.support.TFBioReader;
...
public class SelfieActivity extends Camera2Base implements ImageProcessor, CaptureImageProcessor {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selfie_liveness);

        textureViewLive = findViewById(R.id.textureLive);
